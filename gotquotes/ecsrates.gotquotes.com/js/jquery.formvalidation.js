    ...
    (function() {
        jQuery.fn.formValidation = function(settings, err_msgs) {
            ...
            settings = jQuery.extend({
                ...
                email: /^[a-zA-Z0-9]{1}[a-zA-Z0-9._%+-]{1,62}[a-zA-Z0-9]{1}@[a-zA-Z0-9]{1}[a-zA-Z0-9.-]{1,247}\.(?:[a-zA-Z]{2}|com|org|net|gov|mil|biz|info|mobi|name|aero|jobs|edu|museum|pro|asia|cat|coop|int|mil|tel|travel|ru)$/,
                ...
                // err_message: "Please fill all required fields! (Marked with red background color)\n",
            ...
            return iForm.submit(function() {
                ...
                else if (settings['display_alert'] && err_list.length > 0)	// error validation and display alert on
            ...
            function isValid(obj) { // check if field is valid
                ...
                if (required(obj) && mask(obj) && equal(obj)) {
                    ...
                    obj.next('span').removeClass('check-error');
                    return true;
                }
                
                obj.addClass(settings['err_class']);
                obj.next('span').addClass('check-error');
